  ...
  return (
    <section id="story" className="min-h-dvh w-screen text-blue-50 bg-black">
        <div className="flex size-full flex-col items-center py-10 pb-24">
            <p className="font-general text-sm uppercase md:text-[20px] ">the multiversal ip world</p>
            ...
            <div className="-mt-80 sm:-mt-20 flex w-full justify-center md:-mt-64 md: me-44 md:justify-end ">
                <div className="flex ml-40 h-full w-fit flex-col items-center md:items-start">
