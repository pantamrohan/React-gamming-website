      ...
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
          <BentoCard
            ...
            description="A cross-platform meta app, turning your activities across web2 and web3 games into a rewarding adventure"
          ></BentoCard>
        </BentoTilt>

        <div className="grid h-[135vh]  md:grid-cols-2 grid-rows-3 gap-7">
